...
<!-- ecosystem:start -->
OpenClaw is at **390,457★** and Hermes Agent at **248,799★**, pulled from the GitHub API on 2026-09-25. Grok
Bot is a closed product with no comparable figure: the largest repo in its third-party ecosystem is xAI's own
marketplace at **268★**, 45 days after launch. Numbers this size move daily, so treat them as a snapshot.
<!-- ecosystem:end -->
...
Read from each repository's own file tree on 2026-09-25. Marketplace entries are read at the commit xAI pins, not at HEAD.
...
- [myprivacyagent-plugin](https://github.com/myprivacyagent/myprivacyagent-plugin) by [My Privacy Agent](https://myprivacyagent.com) — read-only MCP server + skill for data-broker opt-outs: step-by-step guides and removal routes for 950+ sites. **[beta]**
